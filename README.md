...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/julia-parsers-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/julia-parsers-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add julia-parsers parsers.jl
# for installing globally
pixi global install julia-parsers parsers.jl
```
...
It is possible to list all of the versions of `julia-parsers` available on your platform:
...
```
pixi search julia-parsers --channel conda-forge
```
